...
class RouteInputViewController: UIViewController {
    ...
    @IBAction func searchButtonTapped(_ sender: UIButton) {
        ...
        if from == "------" || to == "------" {
            directionsTextView.text = "Please select a departure and a destination station."
        } else if from == to {
            directionsTextView.text = "The destination you picked is the same as the departure station. That might not be what you wanted to select."
        } else {
